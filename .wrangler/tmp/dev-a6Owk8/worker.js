...
// .wrangler/tmp/bundle-bxvSqc/checked-fetch.js
...
var _headerDef = `<meta name = "viewport" content = "width=device-width,initial-scale=1"/>
...
var _copyright = `<span id = "footerText"><span id="year"></span> \xA9 ${ENV.copyright}</span>
	<script>document.getElementById("year").innerHTML = new Date().getFullYear();<\/script>`;
var _footerDef = `<div class="mx-auto">
...
app.get("/developer", async (c) => {
  const page = new Page({
    pageTitle: "Developer",
    headerOverwrite: _headerDef + applyCSSTheme("purple"),
...
app.get("/projects", async (c) => {
  const page = new Page({
    pageTitle: "Projects",
    headerOverwrite: _headerDef + applyCSSTheme("blue"),
...
app.get("/api/f1/drivers/:year", async (c) => {
  ...
  console.log();
  const meeting_key = meetings[0].meeting_key;
  console.log();
...
// .wrangler/tmp/bundle-bxvSqc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bxvSqc/middleware-loader.entry.ts
